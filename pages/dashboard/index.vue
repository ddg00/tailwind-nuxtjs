...
<script>
import LineChartComponent from '~/components/tailWindStarterKit/LineChart.vue'
import BarChartComponent from '~/components/tailWindStarterKit/BarChart.vue'
export default {
  name: 'DashboardPage',
  components: {
    LineChartComponent,
  ...
  beforeCreate() {
    this.$store.dispatch('application/initPage', {
      title: 'Dash Board',
      nav: 'dashboard'
    })
  }
